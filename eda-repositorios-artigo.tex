...
No caso do repositório de dados do INESC TEC\footnote{Ligação: \url{https:/rdm.inesctec.pt}}, a FCT negociou um contrato para a aquisição de pacotes de identificadores junto da DataCite\footnote{Ligação: \url{https://datacite.org/}}, que permitiu ao repositório emitir DOI para os conjuntos de dados despositados. 
