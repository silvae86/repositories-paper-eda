...
A recomendação R1.3 é um tema especialmente desafiante e interessante, tanto é que é uma linha de investigação no Laboratório de Sistemas de Informação da FEUP desde 2012: a anexação de metadados específicos do domínio a cada conjunto de dados. 
